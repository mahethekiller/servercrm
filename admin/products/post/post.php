...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['operation']) && $_POST['operation'] === 'add_attribute') {
    // Collect and trim inputs
    ...
    // Basic required fields validation
    if (empty($attributeName) || empty($attributeType || empty($price))  ) {
        echo json_encode(['success' => false, 'message' => 'Please fill in all required fields.']);
        exit;
    }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['operation']) && $_POST['operation'] === 'update_attribute') {
    // Collect and trim inputs
    ...
    // Basic required fields validation
    if (empty($attributeId) || empty($attributeName) || empty($attributeType || empty($price))  ) {
        echo json_encode(['success' => false, 'message' => 'Please fill in all required fields.']);
        exit;
    }
    ...
    if ($db->update('attributes', $data, $where)) {
