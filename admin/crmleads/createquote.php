...
<div class="row">
    <div class="col-12">
        <form id="allProductAttributesForm" method="post"
            action="<?php echo BASE_URL ?>admin/crmleads/post/createquote_post.php">
            <div class="row">
                <div class="col-md-2">
                    <div class="card card-primary">
                        <div class="card-header">
                ...
                <div class="col-md-4">
                    <div class="card card-primary">
                                ...
                                <tbody>
                                    <tr class="billing-info-row">
                                        ...
                                        <td>
                                            ...
                                            <strong>CIN:</strong> <?php echo htmlspecialchars($company['cin_no'] ?: 'N/A'); ?><br>
                                            <strong>PAN:</strong> <?php echo htmlspecialchars($company['pan_no'] ?: 'N/A'); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Antivirus/Backup</td>
                                        <td>
                                            <label><input type="radio" name="antivirus_backup" checked value="No">
                                                No</label>
                                    ...
                                    <tr>
                                        <td>OTC</td>
                                        <td>
                                            <input type="number" class="form-control" id="otc" name="otc"
                                                placeholder="OTC">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-append">
                                                    <button class="btn btn-success" id="sub_total_btn"
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-success" id="submit-quotation"
                                style="display: none;">Create Quote</button>
                        </div>
                    </div>
                </div>
